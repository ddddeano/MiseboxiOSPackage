...
let MBColourDarkBlue = Color(red: 0.10, green: 0.20, blue: 0.45) // A deep, dark blue
let MBColourPaleBlue = Color(red: 0.70, green: 0.85, blue: 0.95) // A light, airy blue
let MBColourPaleGreen = Color(red: 0.76, green: 0.88, blue: 0.78) // A soft, pale green
let MBColourDarkGreen = Color(red: 0.13, green: 0.55, blue: 0.13) // A rich, natural green
let MBColourNaturalPurple = Color(red: 0.58, green: 0.44, blue: 0.86) // A gentle, natural purple inspired by seashells
let MBColourCream = Color(red: 0.92, green: 0.91, blue: 0.88) // A soft, light cream color
...
let userPalette = Palette(color1: MBColourDarkBlue, color2: MBColourPaleGreen)
let chefPalette = Palette(color1: MBColourDarkBlue, color2: MBColourPaleGreen)
...
public struct AvatarView: View {
    ...
    var palette: Palette // Add a palette property
